...
from .views import (
    ...
    CompetitionApplyView,
    CompetitionResultView, 
    PartnerSearchView, 
    CompetitionApplyResultView, 
    CompetitionCancelView,
    MyCompetitionListView)
...
urlpatterns = [
    ...
    path('competitions/<int:pk>/result/', CompetitionResultView.as_view(), name='competition-result'),
